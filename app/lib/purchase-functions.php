...
class Purchase
{
	...
	public $orderInfo = array('order_id' => '', 'order_purchaseticket' => '');
	...
	*/
	...
	public function createGameOrder($buyer_used_id, $order_paymethod, $product_name, $product_id_catalog, $product_sellingsite, $product_siteurl, $product_limitedoffer, $product_usdprice, 
	$product_arsprice, $client_name, $client_email, $client_ip, $discount_coupon, $coupon_discounted_ammount) 
	{
		global $CD_ID;
		global $config;
		
		if(($order_paymethod != 1 && $order_paymethod != 2) || !is_numeric($buyer_used_id) || !is_numeric($product_usdprice) || !is_numeric($product_arsprice) || 
		...
		// Realizar consulta
		$sql = "INSERT INTO `orders` (`order_number`, `order_id`, `associated_userid`, `order_date`, `order_status`, `order_status_change`, `order_confirmed_payment`, `order_payment_time`,
		...
		`order_informed_image`, `order_reserved_game`, `order_sentkeys`, `buyer_name`, `buyer_email`, `buyer_ip`, `cancel_reason`) 
		VALUES (NULL, '".$orderId."', ".$buyer_used_id.", NOW(), 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', '', ".$product_fromcatalog.", '".$product_id_catalog."', ".$product_limited_unit.", 
