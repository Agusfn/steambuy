...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
		...
		<link rel="stylesheet" href="resources/css/order-list-page.css" type="text/css">
		<script type="text/javascript" src="resources/js/order-list-scripts.js"></script>
        ...
        <div class="wrapper">
            ...
            <div class="main_content">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="active">Lista pedidos</li>
                </ol>
						...
						if($count[0] > 0) {
							while($order = mysqli_fetch_assoc($res)) 
							{
								...
								<tr <?php if($order["order_confirmed_payment"] == 1) echo "class='green_row'"; ?>>
									...
									<td align="center"><a href="<?php echo $order["product_site_url"]; ?>" class="product_url"><img src="<?php echo PUBLIC_URL; ?>resources/img/icons/<?php
									...
									<td align="center"><?php 
									if($order["order_paymentmethod"] == 1) echo "<a href='".$order["order_purchaseticket"]."'><img src='resources/img/boleta.png'/></a>";
									else if($order["order_paymentmethod"] == 2) echo "<img src='resources/img/transferencia.png'/>";
									?> </td>
								</tr>
								<?php
							}
