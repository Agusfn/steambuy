...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <link rel="stylesheet" href="resources/css/order-details-page.css" type="text/css">
		<script type="text/javascript" src="resources/js/order-details-scripts.js"></script>
        ...
        <div class="wrapper">
            ...
            <div class="main_content">
                ...
                <ol class="breadcrumb">
                  ...
                  <li><a href="index.php">Lista pedidos</a></li>
				...
				if($orderFound == true) {
                    ...
                    <table class="table" style="table-layout: fixed;margin-top:30px;">
                    	...
                    	<tr>
                            ...
                            <td style="font-size:16px;"><strong>Usuario:</strong> <?php echo "<a href=''>".$orderData["associated_userid"]."</a>"; ?></td>
