...
$login->restricted_page($loggedUser, 2, true);
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <link rel="stylesheet" href="../../resources/vendors/jquery-ui/jquery-ui.min.css" type="text/css">
        <link rel="stylesheet" href="resources/css/catalog-manager-page.css" type="text/css">
        ...
        <script type="text/javascript" src="../../resources/vendors/jquery-ui/jquery-ui.min.js"></script>
        <script type="text/javascript" src="resources/js/datetime_scripts.js"></script>
        <script type="text/javascript" src="resources/js/catalog-manager-scripts.js"></script>
        <?php
        ...
        <div class="wrapper">
            ...
            <div class="main_content">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="active">Lista productos</li>
                </ol>
							...
							if($products["product_enabled"] == 0) echo "style='background-color: rgba(248, 215, 215, 1);'";
                                ...
                                <div class="pcp_top">
                                    <div style="float:left;width: 20px; height:36px;">
                                        ...
                                        <img src="../../resources/img/icons/<?php
