...
$needed_product_data = "product_id, product_name, product_platform, product_has_customprice, product_customprice_currency, product_sellingsite, product_finalprice, product_external_limited_offer, product_listprice, product_mainpicture";
...
function display_catalog_product($pData, $size = "") {
	...
	if($pData === false) {
        echo "<div class='cpg-product ".$size_class."'></div>";
	} else {
		?>
